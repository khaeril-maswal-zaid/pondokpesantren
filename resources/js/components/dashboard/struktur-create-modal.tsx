...
import { PlusCircle, Upload, X, Loader2, Phone } from "lucide-react"
import { z } from "zod"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                />
                {errors.posisi && <p className="text-xs text-destructive">{errors.posisi}</p>}
              </div>

              <div className="space-y-2">
                <Label
                  htmlFor="departemen"
                  className={`text-sm font-medium ${errors.departemen ? "text-destructive" : ""}`}
                >
