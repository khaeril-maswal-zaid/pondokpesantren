...
import { PlusCircle, Upload, X, CropIcon, Loader2, Calendar } from "lucide-react"
import { z } from "zod"
        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label
                htmlFor="nama_agenda"
                className={`text-sm font-medium ${errors.nama_agenda ? "text-destructive" : ""}`}
              >
              ...
              />
              {errors.nama_agenda && <p className="text-xs text-destructive">{errors.nama_agenda}</p>}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {errors.waktu && <p className="text-xs text-destructive">{errors.waktu}</p>}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                />
                {errors.tempat && <p className="text-xs text-destructive">{errors.tempat}</p>}
              </div>
            ...
            <div className="space-y-2">
              <Label
                htmlFor="deskripsi"
                className={`text-sm font-medium ${errors.deskripsi ? "text-destructive" : ""}`}
              >
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex flex-wrap gap-4">
                  ...
                  <div
                    className={`border-2 border-dashed rounded-md p-2 w-[120px] h-[90px] flex flex-col items-center justify-center cursor-pointer hover:border-primary/50 transition-colors ${
